...
load("U:/Research/Projects/sef/bayes_meta_el/SBEL_BYM_lung_male_10000.RData")
# checking traceplot and density plots for convergence
par(mfrow=c(2,2))
plot(1:10000,SBEL_BYM_lung_male[[1]]$Beta[1,],type="l",col="green", main= "Traceplot for intercept")
lines(1:10000,SBEL_BYM_lung_male[[2]]$Beta[1,],type="l",col="blue")
lines(1:10000,SBEL_BYM_lung_male[[3]]$Beta[1,],type="l",col="red")
plot(1:10000,SBEL_BYM_lung_male[[1]]$Beta[2,],type="l",col="green", main= "Traceplot for coeffcient(major cities)")
lines(1:10000,SBEL_BYM_lung_male[[2]]$Beta[2,],type="l",col="blue")
lines(1:10000,SBEL_BYM_lung_male[[3]]$Beta[2,],type="l",col="red")
plot(1:10000,SBEL_BYM_lung_male[[1]]$Beta[3,],type="l",col="green", main= "Traceplot for coeffcient(regional)")
lines(1:10000,SBEL_BYM_lung_male[[2]]$Beta[3,],type="l",col="blue")
lines(1:10000,SBEL_BYM_lung_male[[3]]$Beta[3,],type="l",col="red")
plot(1:10000,SBEL_BYM_lung_male[[1]]$tau,type="l",col="green", main= "Traceplot for precsion")
lines(1:10000,SBEL_BYM_lung_male[[2]]$tau,type="l",col="blue")
lines(1:10000,SBEL_BYM_lung_male[[3]]$tau,type="l",col="red")
...
chain1_beta0<-SBEL_BYM_lung_male[[1]]$Beta[1,]
chain1_beta1<-SBEL_BYM_lung_male[[1]]$Beta[2,]
chain1_beta2<-SBEL_BYM_lung_male[[1]]$Beta[3,]
chain1_psi<-SBEL_BYM_lung_male[[1]]$psi
chain1_tau<-SBEL_BYM_lung_male[[1]]$tau
chain2_beta0<-SBEL_BYM_lung_male[[2]]$Beta[1,]
chain2_beta1<-SBEL_BYM_lung_male[[2]]$Beta[2,]
chain2_beta2<-SBEL_BYM_lung_male[[2]]$Beta[3,]
chain2_psi<-SBEL_BYM_lung_male[[2]]$psi
chain2_tau<-SBEL_BYM_lung_male[[2]]$tau
chain3_beta0<-SBEL_BYM_lung_male[[3]]$Beta[1,]
chain3_beta1<-SBEL_BYM_lung_male[[3]]$Beta[2,]
chain3_beta2<-SBEL_BYM_lung_male[[3]]$Beta[3,]
chain3_psi<-SBEL_BYM_lung_male[[3]]$psi
chain3_tau<-SBEL_BYM_lung_male[[3]]$tau
...
SBEL_BYM_all_lung_male<-list(Beta0_all,Beta1_all,Beta2_all,tau_all,psi_all)
SBEL_BYM_mcmc_lung_male<-list(Beta0.mcmc,Beta1.mcmc,Beta2.mcmc,tau.mcmc,psi.mcmc)
save(SBEL_BYM_all_lung_male,file="Results/SBEL_BYM_all_lung_male.RData")
save(SBEL_BYM_mcmc_lung_male,file="Results/SBEL_BYM_mcmc_lung_male.RData")
...
Beta_BYM_SBEL<- rbind(SBEL_BYM_all_lung_male[[1]],SBEL_BYM_all_lung_male[[2]],SBEL_BYM_all_lung_male[[3]])
psi_BYM_SBEL<-matrix(c(SBEL_BYM_all_lung_male[[5]][[1]]),nrow=27000, ncol=1)
for(i in 2:2148){
  psi_BYM_SBEL<-cbind(psi_BYM_SBEL,SBEL_BYM_all_lung_male[[4]][[i]])
}
tau_BYM_BEL<-SBEL_BYM_all_lung_male[[4]]
theta<-t(Beta_BYM_SBEL)%*%t(x)+psi_BYM_SBEL
#pred_BEL_BYM<-colMeans(theta)
WAIC_BYM_BEL<-get.WAIC.BEL(theta=theta,y=y,x=x)

# Calculation of rank and probabilities
#ranking theta's for all iterations
regional_mean_output<-data.frame(mean_major_cities=exp(SBEL_BYM_all_lung_male[[2]]),
                                 mean_regional=exp(SBEL_BYM_all_lung_male[[3]]),
                                 mean_remotes=exp(SBEL_BYM_all_lung_male[[1]]))
...
load("Results/SBEL_BYM_all_lung_male.RData")
regional_mean_output_lung_meta<-data.frame(Major_cities=exp(SBEL_BYM_all_lung_male[[2]]),
                                           Regional=exp(SBEL_BYM_all_lung_male[[3]]),
                                           Remote=exp(SBEL_BYM_all_lung_male[[1]]))
